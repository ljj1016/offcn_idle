...
<div class="formbody">
	<div class="formtitle" style="cursor: pointer;" id="formtitle"><span>添加</span></div>
	<form action="selectbyKeyword" method="post">
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>关键词</label>
			<input name="" type="text" class="dfinput" id="keywords"/>
			<i>关键词不能超过10个字符</i>
		</li>
		<li>
			<label>&nbsp;</label>
			<input name="" onclick="savekeyword()" type="button" class="btn" value="添加"/>
		</li>
	</ul>
	</form>
</div>
<div class="rightinfo">
	<div class="tools">
		<ul class="toolbar">
			...
			<li class="click" onclick="deletekeyword()"><span><img src="images/t03.png"/></span>删除</li>
